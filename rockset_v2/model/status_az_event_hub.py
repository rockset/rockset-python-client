...
def lazy_import():
    from rockset_v2.model.status_az_event_hub_partition import StatusAzEventHubPartition
    globals()['StatusAzEventHubPartition'] = StatusAzEventHubPartition


class StatusAzEventHub(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'partitions': ([StatusAzEventHubPartition],),  # noqa: E501
            'state': (str,),  # noqa: E501
        }
