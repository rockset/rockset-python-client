...
def lazy_import():
    from rockset_v2.model.redshift_integration import RedshiftIntegration
    globals()['RedshiftIntegration'] = RedshiftIntegration


class RedshiftIntegrationCreationRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        """RedshiftIntegrationCreationRequest - a model defined in OpenAPI
