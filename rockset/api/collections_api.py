...
class CollectionsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_redshift_collection_endpoint = _Endpoint(
            settings={
                'response_type': (CreateCollectionResponse,),
                'auth': [
                    'apikey'
                ],
                'endpoint_path': '/v1/orgs/self/ws/{workspace}/collections#Redshift'.split('#')[0],
                'operation_id': 'create_redshift_collection',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'workspace',
                    'redshift_collection_creation_request',
                ],
                'required': [
                    'workspace',
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'workspace': 'path',
                    'redshift_collection_creation_request': 'body',
                },
                'collection_format_map': {
                }
            },
...
```
    ...
    def create_redshift_collection(
        self,
        *,
        name: str,
        clustering_key: typing.Sequence[FieldPartition] = None,
        ...
        inverted_index_group_encoding_options: InvertedIndexGroupEncodingOptions = None,
        retention_secs: int = None,
        sources: typing.Sequence[RedshiftSourceWrapper] = None,
        time_partition_resolution_secs: int = None,
        workspace = "commons",
        **kwargs
    ) -> typing.Union[CreateCollectionResponse, asyncio.Future]:
        """Create redshift collection  # noqa: E501
...
```python
rs = RocksetClient(apikey=APIKEY)
future = rs.CollectionsApi.create_redshift_collection(
    clustering_key=[
        FieldPartition(
            field_name="address.city.zipcode",
            keys=[
...
```
        ...
        Keyword Args:
            ...
            name (str): unique identifier for collection, can contain alphanumeric or dash characters. [required]
            retention_secs (int): number of seconds after which data is purged, based on event time. [optional]
            sources ([RedshiftSourceWrapper]): List of sources from which to ingest data. [optional]
            time_partition_resolution_secs (int): If non-null, the collection will be time partitioned and each partition will be time_partition_resolution_secs wide.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
        ...
        kwargs['workspace'] = \
            workspace
        kwargs['redshift_collection_creation_request'] = \
            kwargs['redshift_collection_creation_request']
        return self.create_redshift_collection_endpoint.call_with_http_info(**kwargs)
...
```
    ...
    body_params_dict['create_redshift_collection'] = 'redshift_collection_creation_request'
    return_types_dict['create_redshift_collection'] = RedshiftCollectionCreationRequest
