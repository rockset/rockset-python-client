...
class FieldMaskMask(object):
    ...
    """
    openapi_types = {"args": "object", "name": "str"}

    attribute_map = {"args": "args", "name": "name"}

    def __init__(
        self, args=None, name=None, local_vars_configuration=None
    ):  # noqa: E501
        """FieldMaskMask - a model defined in OpenAPI"""  # noqa: E501
