...
class QueryLambdaSql(object):
    ...
    """
    openapi_types = {"default_parameters": "list[QueryParameter]", "query": "str"}

    attribute_map = {"default_parameters": "default_parameters", "query": "query"}

    def __init__(
        self, default_parameters=None, query=None, local_vars_configuration=None
    ):  # noqa: E501
        """QueryLambdaSql - a model defined in OpenAPI"""  # noqa: E501
    ...
    def default_parameters(self, default_parameters):
        ...
        :type default_parameters: list[QueryParameter]
        """
