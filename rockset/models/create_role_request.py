...
class CreateRoleRequest(object):
    ...
    def __init__(self, description=None, privileges=None, role_name=None, local_vars_configuration=None):  # noqa: E501
        """CreateRoleRequest - a model defined in OpenAPI"""  # noqa: E501
