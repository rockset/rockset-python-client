...
class VirtualInstance(object):
    ...
    def __init__(self, state=None, current_type=None, desired_type=None, current_size=None, desired_size=None, last_updated=None, estimated_switch_duration_minutes=None, monitoring_enabled=None, default_pod_count=None, scaled_pod_count=None, id=None, _configuration=None):  # noqa: E501
    ...
    def current_type(self, current_type):
        ...
        if (self._configuration.client_side_validation and
                current_type not in allowed_values):
            raise ValueError(
    ...
    def desired_type(self, desired_type):
        ...
        allowed_values = ["FREE", "SHARED", "SMALL", "MEDIUM", "LARGE", "XLARGE", "XLARGE2", "XLARGE4", "XLARGE8", "XLARGE16"]  # noqa: E501
        if (self._configuration.client_side_validation and
                desired_type not in allowed_values):
            raise ValueError(
    ...
    def current_size(self, current_size):
        ...
        allowed_values = ["FREE", "SHARED", "SMALL", "MEDIUM", "LARGE", "XLARGE", "XLARGE2", "XLARGE4", "XLARGE8", "XLARGE16"]  # noqa: E501
        if (self._configuration.client_side_validation and
                current_size not in allowed_values):
            raise ValueError(
    ...
    def desired_size(self, desired_size):
        ...
        allowed_values = ["FREE", "SHARED", "SMALL", "MEDIUM", "LARGE", "XLARGE", "XLARGE2", "XLARGE4", "XLARGE8", "XLARGE16"]  # noqa: E501
        if (self._configuration.client_side_validation and
                desired_size not in allowed_values):
            raise ValueError(
