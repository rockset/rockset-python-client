...
class CreateIntegrationRequest(object):
    ...
    def __init__(self, name=None, description=None, s3=None, kinesis=None, dynamodb=None, redshift=None, gcs=None, azure_blob_storage=None, azure_event_hub=None, segment=None, kafka=None, mongodb=None, _configuration=None):  # noqa: E501
