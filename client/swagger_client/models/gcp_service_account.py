...
class GcpServiceAccount(object):
    ...
    def __init__(self, service_account_key_file_json=None, _configuration=None):  # noqa: E501
    ...
    def service_account_key_file_json(self, service_account_key_file_json):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and service_account_key_file_json is None:
