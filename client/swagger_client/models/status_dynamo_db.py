...
class StatusDynamoDb(object):
    ...
    def __init__(self, scan_start_time=None, scan_end_time=None, scan_records_processed=None, scan_total_records=None, state=None, stream_last_processed_at=None, _configuration=None):  # noqa: E501
