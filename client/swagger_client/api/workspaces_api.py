...
class WorkspacesApi(object):
    ...
    def child_workspaces(self, workspace, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.child_workspaces_with_http_info(workspace, **kwargs)  # noqa: E501
        else:
            (data) = self.child_workspaces_with_http_info(workspace, **kwargs)  # noqa: E501
            return data

    def child_workspaces_with_http_info(self, workspace, **kwargs):  # noqa: E501
        """List Workspaces in Workspace  # noqa: E501

        List workspaces under given workspace.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.child_workspaces_with_http_info(workspace, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method child_workspaces" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('workspace' not in params or
            ...
            raise ValueError("Missing the required parameter `workspace` when calling `child_workspaces`")  # noqa: E501
