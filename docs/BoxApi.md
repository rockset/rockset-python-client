...
------------- | ------------- | -------------
[**create_box**](BoxApi.md#create_box) | **POST** /v1/search/boxes | Create a box
[**delete_box**](BoxApi.md#delete_box) | **DELETE** /v1/search/boxes/{box_rrn} | Delete a box
[**delete_pallet**](BoxApi.md#delete_pallet) | **DELETE** /v1/search/pallets/{pallet_id} | Delete a pallet
[**insert_docs**](BoxApi.md#insert_docs) | **POST** /v1/search/boxes/{box_rrn}/documents | Insert documents into a box
[**list_pallet_boxes**](BoxApi.md#list_pallet_boxes) | **GET** /v1/search/pallets/{pallet_id}/boxes | Get the boxes associated with a pallet ID within this cluster
[**query_box**](BoxApi.md#query_box) | **POST** /v1/search/boxes/{box_rrn}/query | Query a box
[**upgrade_box**](BoxApi.md#upgrade_box) | **POST** /v1/search/boxes/{box_rrn}/resize | Resize a box
...
# Create a box
api_response = rs.Box.create_box(
)
pprint(api_response)
# Error responses from the server will cause the client to throw an ApiException
# except ApiException as e:
#     print("Exception when calling Box->create_box: %s\n" % e)

# asynchronous example passing optional values and required values which don't have defaults set
# assumes that execution takes place within an asynchronous context
# Create a box
api_response = await rs.Box.create_box(
    async_req=True,
)
...
# synchronous example passing only required values which don't have defaults set
# Delete a box
api_response = rs.Box.delete_box(
    box_rrn="box_rrn_example",
)
pprint(api_response)
# Error responses from the server will cause the client to throw an ApiException
# except ApiException as e:
#     print("Exception when calling Box->delete_box: %s\n" % e)

# asynchronous example passing optional values and required values which don't have defaults set
# assumes that execution takes place within an asynchronous context
# Delete a box
api_response = await rs.Box.delete_box(
    box_rrn="box_rrn_example",
    async_req=True,
)
if isinstance(api_response, rockset.ApiException):
...
# synchronous example passing only required values which don't have defaults set
# Delete a pallet
rs.Box.delete_pallet(
    pallet_id="pallet_id_example",
)
# Error responses from the server will cause the client to throw an ApiException
# except ApiException as e:
#     print("Exception when calling Box->delete_pallet: %s\n" % e)
...
# synchronous example passing only required values which don't have defaults set
# Insert documents into a box
api_response = rs.Box.insert_docs(
    box_rrn="box_rrn_example",
)
pprint(api_response)
# Error responses from the server will cause the client to throw an ApiException
# except ApiException as e:
#     print("Exception when calling Box->insert_docs: %s\n" % e)

# asynchronous example passing optional values and required values which don't have defaults set
# assumes that execution takes place within an asynchronous context
# Insert documents into a box
api_response = await rs.Box.insert_docs(
    box_rrn="box_rrn_example",
    async_req=True,
)
if isinstance(api_response, rockset.ApiException):
...
# synchronous example passing only required values which don't have defaults set
# Get the boxes associated with a pallet ID within this cluster
api_response = rs.Box.list_pallet_boxes(
    pallet_id="pallet_id_example",
)
pprint(api_response)
# Error responses from the server will cause the client to throw an ApiException
# except ApiException as e:
#     print("Exception when calling Box->list_pallet_boxes: %s\n" % e)

# asynchronous example passing optional values and required values which don't have defaults set
# assumes that execution takes place within an asynchronous context
# Get the boxes associated with a pallet ID within this cluster
api_response = await rs.Box.list_pallet_boxes(
    pallet_id="pallet_id_example",
    async_req=True,
)
if isinstance(api_response, rockset.ApiException):
...
# synchronous example passing only required values which don't have defaults set
# Query a box
api_response = rs.Box.query_box(
    box_rrn="box_rrn_example",
)
pprint(api_response)
# Error responses from the server will cause the client to throw an ApiException
# except ApiException as e:
#     print("Exception when calling Box->query_box: %s\n" % e)

# asynchronous example passing optional values and required values which don't have defaults set
# assumes that execution takes place within an asynchronous context
# Query a box
api_response = await rs.Box.query_box(
    box_rrn="box_rrn_example",
    async_req=True,
)
if isinstance(api_response, rockset.ApiException):
...
# synchronous example passing only required values which don't have defaults set
# Resize a box
api_response = rs.Box.upgrade_box(
    box_rrn="box_rrn_example",
)
pprint(api_response)
# Error responses from the server will cause the client to throw an ApiException
# except ApiException as e:
#     print("Exception when calling Box->upgrade_box: %s\n" % e)

# asynchronous example passing optional values and required values which don't have defaults set
# assumes that execution takes place within an asynchronous context
# Resize a box
api_response = await rs.Box.upgrade_box(
    box_rrn="box_rrn_example",
    async_req=True,
)
if isinstance(api_response, rockset.ApiException):
